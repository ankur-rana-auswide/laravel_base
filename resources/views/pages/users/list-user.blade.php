...
<main class="h-full overflow-y-auto px-6">
    <div class="container mx-auto py-6">
        <div class="flex flex-col md:flex-row justify-between items-center mb-4 space-y-4 md:space-y-0" style="flex-direction: unset;">
            <h1 class="mt-5 text-2xl font-bold text-gray-700">List Users</h1>
            <a href="{{ route('user.create') }}">
                <button class="bg-black text-yellow-600 px-4 h-10 rounded shadow hover:bg-yellow-600 hover:text-white">
        ...
        <div class="bg-white shadow rounded mb-6">
            ...
            <select class="w-full md:w-32 border rounded py-2 px-3 mb-4 md:mb-0 md:mr-4">
                <option>Admin</option>
            ...
            <button class="w-full md:w-32 bg-black text-yellow-600 px-4 h-10 rounded shadow hover:bg-yellow-600 hover:text-white">
        ...
        <table class="min-w-full bg-white shadow rounded">
            <thead>
                <tr>
                    ...
                    <th class="py-3 px-4 border-b text-left">User Role</th>
                    <th class="py-3 px-4 border-b text-left">Email ID</th>
