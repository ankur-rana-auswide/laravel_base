...
<main class="h-full overflow-y-auto px-6 bg-white">
        <div class="flex justify-between items-center mt-3 p-5">
            <h1 class="text-3xl font-bold">Edit Installer</h1>
        </div>
    <div class="mx-auto grid mt-1 bg-gray-100 p-5">
        ...
        <div class="grid-container">
            <div class="p-6 mb-6">
                          <!-- Permissions Table -->
                    <div class="mb-4">
                        <label for="role_name" class="block text-xs text-gray-700 mb-2">INSTALLER NAME</label>
        ...
        <div class="p-6 mb-6 text-right">
            <a href="{{ route('user.installer.list') }}"><button class="w-[10%] bg-white text-black px-5 h-8 rounded shadow hover:bg-black hover:text-white"> Cancel</button></a>
