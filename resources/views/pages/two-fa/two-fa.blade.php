...
<div class="block max-w-md rounded-lg bg-white p-6 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-700">
	...
	<?php if($check_2fa->is_2fa_enable != 1){ // when user not enabled 2FA ?>
			...
			<div class="w-full mb-6 mt-6" role="alert">
				<button type="button" id="generate_qr_code" class="mt-1 text-white p-2.5 rounded-[5px] bg-[#4F46E5] hover:bg-[#2d0279] text-sm cursor-pointer inline-block w-full rounded bg-primary px-6 pb-2 pt-2.5 text-xs font-medium uppercase  shadow-[0_4px_9px_-4px_#3b71ca] " data-te-ripple-init data-te-ripple-color="light">
					Generate QR code
				</button>
				<div class="mt-3">
						...
						@endif
						<button type="button" id="enable_fa" class="mt-1 text-white p-2.5 rounded-[5px] bg-[#4F46E5] hover:bg-[#2d0279] text-sm cursor-pointer inline-block w-full rounded bg-primary px-6 pb-2 pt-2.5 text-xs font-medium uppercase  shadow-[0_4px_9px_-4px_#3b71ca] " data-te-ripple-init data-te-ripple-color="light">Enable</button>
				</div>
			</div>
