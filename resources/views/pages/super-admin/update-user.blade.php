                                ...
                                <div class="w-full lg:w-5/6">
                                    ...
                                    <div class="mt-2 flex gap-x-6 gap-y-6 flex-col lg:flex-row">
                                        <div class="w-full">
                                            ...
                                            <div class="mt-[10px]">
                                                <input type="email" value="{{old('email',$user_detail->email)}}" name="email" id="email"
                                    ...
                                    <div class="mt-2 flex gap-x-6 gap-y-6 flex-col lg:flex-row w-full">
                                            <div style="width: 50%;">
                                    ...
                                    <div class="mt-2 bg-white py-3 text-sm tracking-wide text-black dark:border-gray-700 dark:text-gray-400 dark:bg-gray-800 justify-end flex gap-2.5">
