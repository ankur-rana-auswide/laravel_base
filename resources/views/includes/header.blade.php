...
<header class="z-10 py-5 bg-white shadow-md dark:bg-gray-800">
				<div class="flex items-center justify-between h-full px-6 mx-auto text-black-600 dark:text-black-300">
					...
					<form class="relative flex flex-1">
						...
						<svg class="cust_search pointer-events-none absolute inset-y-0 left-0 h-full w-5 text-gray-400" viewBox="0 0 20 20"
						...
						<!-- <input id="search-field"
							class="block h-full w-full border-0 py-0 pl-8 pr-0 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm outline-0"
							placeholder="Search..." type="search" name="search"> -->


							<input readonly id="open_all_search"
							class="block h-full w-full border-0 py-0 pl-8 pr-0 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm outline-0"
							placeholder="Search..." type="search" name="search">
